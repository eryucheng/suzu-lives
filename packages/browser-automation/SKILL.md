...
软件配置仅从当前 Agent 的 Suzu Lives 数据目录读取：`agents/<agentId>/site-automation/config.json`。不要从 Claude 项目目录读取或依赖配置、运行状态、源码或浏览器 profile。
