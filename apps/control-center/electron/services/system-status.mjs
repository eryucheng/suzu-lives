...
const SUZU_CAPABILITY_ENTRIES = new Set([
  "computer-camera", "image-generation", "image-vision", "iphone-bridge", "managed-registrations-v1.json", "phone-camera", "site-automation", "time-awareness", "traveling-merchant", "video-understanding", "voice-message", "web-browser",
]);
