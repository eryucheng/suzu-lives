...
import { claudeAgentAbilityCatalog, inspectClaudeRegistration, removeClaudeRegistration, writeClaudeRegistration } from "@suzu-lives/claude-integration";
...
const CONTACT_SCOPED_AGENT_CAPABILITY_IDS = new Set(["image-generation", "phone-camera", "voice-message", "image-vision", "video-understanding", "iphone-bridge"]);
const CONTACT_SCOPED_AUTOMATION_CAPABILITY_IDS = new Set(["proactive-contact"]);
